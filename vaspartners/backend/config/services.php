...
return [
    ...
    */
    'etrade' => [
        ...
        'portal_lookups_per_minute' => (int) env('ETRADE_PORTAL_LOOKUPS_PER_MINUTE', 10),
        'portal_lookups_per_ip_minute' => (int) env('ETRADE_PORTAL_LOOKUPS_PER_IP_MINUTE', 30),
        'portal_lookups_per_hour' => (int) env('ETRADE_PORTAL_LOOKUPS_PER_HOUR', 25),
        'portal_lookups_per_day' => (int) env('ETRADE_PORTAL_LOOKUPS_PER_DAY', 50),
        'portal_unique_tins_per_day' => (int) env('ETRADE_PORTAL_UNIQUE_TINS_PER_DAY', 20),
