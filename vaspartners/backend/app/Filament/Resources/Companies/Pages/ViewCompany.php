        ...
        return [
            ...
            ActionGroup::make([
                ...
                Action::make('force_purge')
                    ...
                    ->color('danger')
                    ->visible(fn (): bool => app(CompanyPurgeService::class)->canForcePurge($this->getRecord()))
                    ->requiresConfirmation()
                    ->modalHeading('Permanently delete company?')
                    ->modalDescription('Permanently deletes this company, memberships, subscriptions, service requests, attachments, and contacts that only belong here. Cannot be undone. Companies with an owner, approved valid TIN, and at least one subscription cannot be deleted.')
